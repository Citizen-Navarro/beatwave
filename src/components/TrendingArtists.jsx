...
export default function TrendingArtists() {
  return (
    <div className="relative w-full min-h-screen bg-black">
      {/* Background */}
      <div className="absolute inset-0 bg-black bg-cover bg-center bg-no-repeat z-0"
           style={{ backgroundImage: "url('/black-headphones.jpg')" }}></div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4 sm:px-8 md:px-12 pt-24 sm:pt-28 md:pt-32 pb-16">
        ...
        <p className="text-gray-500 text-base sm:text-lg md:text-xl text-center max-w-xl sm:max-w-2xl md:max-w-3xl mb-8 sm:mb-10 md:mb-12">
          Discover the most streamed, most loved, and most talked-about artists lighting up playlists across the globe. From underground gems to global chart-toppers — they’re all here.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-8 w-full max-w-7xl">
          {artists.map((artist, idx) => (
            ...
            >
              ...
              <h2 className="text-lg sm:text-xl font-inder text-white">{artist.name}</h2>
              <hr className="border-purple-900 w-32 sm:w-40 my-2 sm:my-3" />
              <p className="text-gray-500 text-xs sm:text-sm mb-4 sm:mb-6">{artist.listeners}</p>
